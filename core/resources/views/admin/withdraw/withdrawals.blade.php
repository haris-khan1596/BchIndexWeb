                            ...
                            <tbody>
                                @forelse($withdrawals as $withdraw)
                                    <tr>
                                        ...
                                        <td>
                                            {{ showAmount(($withdraw->amount/$withdraw->crypto->rate)-($withdraw->charge/$withdraw->crypto->rate), 8) }} {{ __($withdraw->crypto->code) }} - <span class="text-danger" title="@lang('charge')">{{ showAmount($withdraw->charge/$withdraw->crypto->rate, 8) }} {{ __($withdraw->crypto->code) }}</span>
                                            <br>
                                            <strong title="@lang('Amount after charge')">
                                                {{ showAmount($withdraw->amount - $withdraw->charge, 8) }} USD
                                                
                                                <!--{{ __($withdraw->crypto->code) }}-->
                                            </strong>
                                        </td>
