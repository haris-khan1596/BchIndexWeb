    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.spotTrading.charge') }}">
                    <a href="{{ route('admin.spotTrading.charge') }}" class="nav-link ">
                        <i class="menu-icon las la-coins"></i>
                        <span class="menu-title">Spot Trading</span>
                    </a>
                </li>
