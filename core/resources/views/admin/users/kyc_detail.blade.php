                          ...
                          <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span>
                                ...
                                @elseif($val->type == 'file')
                                    @if($val->value)
                                        <img style="width: 150px" src="/{{ (getFilePath('verify').'/'.$val->value) }}">
{{--                                        <a target="_blank" href="/{{ (getFilePath('verify').'/'.$val->value) }}" class="me-3"><i class="fa fa-file"></i>  @lang('Attachment') </a>--}}
                                    @else
                                        @lang('No File')
                                    @endif
                                @else
