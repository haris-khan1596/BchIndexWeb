        ...
        <div class="col-12">
                ...
                @foreach ($wallets as $wallet)
                    <div class="col-xxl-3 col-sm-6">
                        <div class="widget-two box--shadow2 b-radius--5 bg--white">
                            ...
                            <div class="widget-two__content">
                                <h3>{{ showAmount($wallet->balance/($wallet->crypto->rate!=0?$wallet->crypto->rate:1), 8) }} {{ __($wallet->crypto->code) }}</h3>
            ...
            <div class="card mt-30">
                ...
                <div class="card-body">
                    ...
                    <div class="flex-fill">
                    <a onclick="return confirm('Are you sure you want to delete this user?');" href="{{ route('admin.users.delete', $user->id) }}" class="btn btn--info btn--shadow w-100 btn-lg">
                            <i class="las la-user-remove"></i>@lang('Delete User')
                        </a>
                        </div>
                </div>
            </div>
