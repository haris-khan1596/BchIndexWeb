                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="fw-bold @if ($transaction->trx_type == '+') text--success @else text-danger @endif">
                                                        ...
                                                        <?php if (isset($transaction->remark) && strpos($transaction->remark, 'p2p_transfer') !== false) {?>
                                                        
                                                        {{ showAmount($transaction->amount/$transaction->crypto->rate, 6) }}
                                                ...
                                                <?php if (isset($transaction->remark) && strpos($transaction->remark, 'p2p_transfer') !== false) {?>
                                                <td><a href="{{route('user.transfer-user-receipt',[$transaction->id,false])}}" target="_blank">P2P Receipt</a></td>
                                                <?php } ?>
                                            </tr>
                                        @endforeach
                                    </tbody>
