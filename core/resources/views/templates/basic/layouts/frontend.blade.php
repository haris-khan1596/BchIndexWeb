...
<script>
    jQuery(".test_info a").click(function () {
        ...
        console.log(href);
        jQuery('#confirm_modal').modal('show',{backdrop: 'static', keyboard: false});
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Please read the seller's terms and conditions carefully before clicking the paid icon and transfer the amount to the seller's account through your banking application. The seller's bank account details can be found in the payment details by going to the up order details. Fraud reporting: If the buyer asks to release the first crypto without paying, please immediately report to BCH INDEX Limited at this email (p2p@bchindex.com)</p>
            </div>
