                    ...
                    @foreach ($advertisements as $ad)
                        <tr>
                            ...
                            <td>
                                ...
                                {{ $rate }} {{ __($ad->fiat->code) }}/ {{ __($ad->crypto->code) }}
                            </td>
                            ...
                            <td>
                                @if ($ad->status == 1)
                                    <span class="badge badge--success">@lang('Eanbled')</span>
                                @else
                            ...
                            @if (!request()->routeIs('user.home'))
                                <td>
                                    <div class="btn--group">
                                        ...
                                        <a href="{{ route('user.advertisement.delete', $ad->id) }}" class="btn btn-outline--danger"><i class="la la-pencil"></i> @lang('Delete')</a>
