...
@section('content')
    <div class="container pt-60 pb-60">
        <div class="row justify-content-center mt-4">
            <div class="col-md-12">
                <div class="text-end">
                    <a href="{{ route('ticket') }}" class="btn btn-sm btn--base mb-4"><i class="las la-ticket-alt"></i> @lang('All Tickets')</a>
                </div>
                <div class="card custom--card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data" onsubmit="return submitUserForm();">
                            ...
                            <div>
                                <button class="btn btn--base w-100 mt-4" type="submit" id="recaptcha">@lang('Submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
