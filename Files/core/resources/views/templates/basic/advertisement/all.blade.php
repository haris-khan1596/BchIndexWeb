                                ...
                                <table class="table custom--table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($advertisements as $ad)
                                            ...
                                            @if ($show)
                                                @php $i++; @endphp
                                                <tr class="@if (auth()->id() == $ad->user->id) own-trade-color @endif">
                                                    ...
                                                    <td class="fw-bold">{{ $rate }} {{ __($ad->fiat->code) }}/ {{ __($ad->crypto->code) }}</td>

                                                    <td>{{ $ad->window }} @lang('Minutes')</td>

                                                    <td>
                                                        {{ showAmount($ad->min) }} {{ __($ad->fiat->code) }} - {{ showAmount($maxLimit) }} {{ __($ad->fiat->code) }}
                                                    </td>
